...
class ExploreTopItemAdapter : RecyclerView.Adapter<ExploreTopItemAdapter.VAdapter>() {
    var showShimmer = true
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ExploreTopItemAdapter.VAdapter {
        return VAdapter(
    ...
    override fun onBindViewHolder(holder: ExploreTopItemAdapter.VAdapter, position: Int) {
